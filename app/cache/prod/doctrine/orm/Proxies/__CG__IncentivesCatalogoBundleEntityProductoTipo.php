 ...
 */
class ProductoTipo extends \Incentives\CatalogoBundle\Entity\ProductoTipo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Incentives\\CatalogoBundle\\Entity\\ProductoTipo' . "\0" . 'id', '' . "\0" . 'Incentives\\CatalogoBundle\\Entity\\ProductoTipo' . "\0" . 'nombre', 'producto', '' . "\0" . 'Incentives\\CatalogoBundle\\Entity\\ProductoTipo' . "\0" . 'fechaModificacion', 'usuario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductoTipo $proxy) {
