 ...
 */
class Redencionesestado extends \Incentives\RedencionesBundle\Entity\Redencionesestado implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'nombre', 'fechaModificacion', 'redencion', 'usuario');
    }
