 ...
 */
class Prioridad extends \Incentives\SolicitudesBundle\Entity\Prioridad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Incentives\\SolicitudesBundle\\Entity\\Prioridad' . "\0" . 'id', '' . "\0" . 'Incentives\\SolicitudesBundle\\Entity\\Prioridad' . "\0" . 'nombre', '' . "\0" . 'Incentives\\SolicitudesBundle\\Entity\\Prioridad' . "\0" . 'fechaModificacion', 'usuario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Prioridad $proxy) {
