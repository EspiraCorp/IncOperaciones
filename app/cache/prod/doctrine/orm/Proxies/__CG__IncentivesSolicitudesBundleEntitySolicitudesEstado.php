 ...
 */
class SolicitudesEstado extends \Incentives\SolicitudesBundle\Entity\SolicitudesEstado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesEstado' . "\0" . 'id', '' . "\0" . 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesEstado' . "\0" . 'nombre', 'solicitud', '' . "\0" . 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesEstado' . "\0" . 'fechaModificacion', 'usuario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SolicitudesEstado $proxy) {
