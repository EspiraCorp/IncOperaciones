 ...
 */
class CatalogoTipo extends \Incentives\CatalogoBundle\Entity\CatalogoTipo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Incentives\\CatalogoBundle\\Entity\\CatalogoTipo' . "\0" . 'id', '' . "\0" . 'Incentives\\CatalogoBundle\\Entity\\CatalogoTipo' . "\0" . 'nombre', 'catalogo', '' . "\0" . 'Incentives\\CatalogoBundle\\Entity\\CatalogoTipo' . "\0" . 'fechaModificacion', 'usuario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CatalogoTipo $proxy) {
    ...
    public function addCatalogo(\Incentives\CatalogoBundle\Entity\Catalogos $catalogos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCatalogo', [$catalogos]);

        return parent::addCatalogo($catalogos);
    }
    ...
    public function removeCatalogo(\Incentives\CatalogoBundle\Entity\Catalogos $catalogos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCatalogo', [$catalogos]);

        return parent::removeCatalogo($catalogos);
    }
    ...
    public function getCatalogos()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCatalogos', []);
