...
namespace Proxies\__CG__\Incentives\BaseBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Usuario extends \Incentives\BaseBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Incentives\\BaseBundle\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'Incentives\\BaseBundle\\Entity\\Usuario' . "\0" . 'username', '' . "\0" . 'Incentives\\BaseBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'Incentives\\BaseBundle\\Entity\\Usuario' . "\0" . 'salt', '' . "\0" . 'Incentives\\BaseBundle\\Entity\\Usuario' . "\0" . 'password', '' . "\0" . 'Incentives\\BaseBundle\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'Incentives\\BaseBundle\\Entity\\Usuario' . "\0" . 'isActive', '' . "\0" . 'Incentives\\BaseBundle\\Entity\\Usuario' . "\0" . 'grupos', '' . "\0" . 'Incentives\\BaseBundle\\Entity\\Usuario' . "\0" . 'proveedor', '' . "\0" . 'Incentives\\BaseBundle\\Entity\\Usuario' . "\0" . 'cliente', 'solicitudasignar'];
        }
