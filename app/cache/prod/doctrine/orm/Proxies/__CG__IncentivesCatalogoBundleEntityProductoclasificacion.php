 ...
 */
class Productoclasificacion extends \Incentives\CatalogoBundle\Entity\Productoclasificacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Incentives\\CatalogoBundle\\Entity\\Productoclasificacion' . "\0" . 'id', '' . "\0" . 'Incentives\\CatalogoBundle\\Entity\\Productoclasificacion' . "\0" . 'nombre', 'producto', '' . "\0" . 'Incentives\\CatalogoBundle\\Entity\\Productoclasificacion' . "\0" . 'fechaModificacion', 'usuario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Productoclasificacion $proxy) {
