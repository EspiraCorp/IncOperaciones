 ...
 */
class Participantesestado extends \Incentives\RedencionesBundle\Entity\Participantesestado implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'nombre', 'fechaModificacion', 'participante', 'usuario');
    }
