 ...
 */
class CotizacionesEstado extends \Incentives\SolicitudesBundle\Entity\CotizacionesEstado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Incentives\\SolicitudesBundle\\Entity\\CotizacionesEstado' . "\0" . 'id', '' . "\0" . 'Incentives\\SolicitudesBundle\\Entity\\CotizacionesEstado' . "\0" . 'nombre', '' . "\0" . 'Incentives\\SolicitudesBundle\\Entity\\CotizacionesEstado' . "\0" . 'fechaModificacion', 'usuario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CotizacionesEstado $proxy) {
