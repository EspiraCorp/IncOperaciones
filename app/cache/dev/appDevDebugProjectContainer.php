...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'incentives_catalogo' => 'getIncentivesCatalogoService',
            'incentives_inventario' => 'getIncentivesInventarioService',
            'incentives_redenciones' => 'getIncentivesRedencionesService',
            'insert.listener' => 'getInsert_ListenerService',
            ...
            'postpersist.listener' => 'getPostpersist_ListenerService',
            ...
            'update.listener' => 'getUpdate_ListenerService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'prePersist'), $this->get('insert.listener'));
        $c->addEventListener(array(0 => 'preUpdate'), $this->get('update.listener'));
        $c->addEventListener(array(0 => 'postPersist'), $this->get('postpersist.listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'incoperaciones_prod', 'user' => 'root', 'password' => 'orwell', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Incentives/OperacionesBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Incentives/BaseBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Incentives/CatalogoBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Incentives/RedencionesBundle/Entity'), 4 => ($this->targetDirs[3].'/src/Incentives/InventarioBundle/Entity'), 5 => ($this->targetDirs[3].'/src/Incentives/ServiciosBundle/Entity'), 6 => ($this->targetDirs[3].'/src/Incentives/GarantiasBundle/Entity'), 7 => ($this->targetDirs[3].'/src/Incentives/FacturacionBundle/Entity'), 8 => ($this->targetDirs[3].'/src/Incentives/OrdenesBundle/Entity'), 9 => ($this->targetDirs[3].'/src/Incentives/SolicitudesBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Incentives\\OperacionesBundle\\Entity');
        $c->addDriver($b, 'Incentives\\BaseBundle\\Entity');
        $c->addDriver($b, 'Incentives\\CatalogoBundle\\Entity');
        $c->addDriver($b, 'Incentives\\RedencionesBundle\\Entity');
        $c->addDriver($b, 'Incentives\\InventarioBundle\\Entity');
        $c->addDriver($b, 'Incentives\\ServiciosBundle\\Entity');
        $c->addDriver($b, 'Incentives\\GarantiasBundle\\Entity');
        $c->addDriver($b, 'Incentives\\FacturacionBundle\\Entity');
        $c->addDriver($b, 'Incentives\\OrdenesBundle\\Entity');
        $c->addDriver($b, 'Incentives\\SolicitudesBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('IncentivesOperacionesBundle' => 'Incentives\\OperacionesBundle\\Entity', 'IncentivesBaseBundle' => 'Incentives\\BaseBundle\\Entity', 'IncentivesCatalogoBundle' => 'Incentives\\CatalogoBundle\\Entity', 'IncentivesRedencionesBundle' => 'Incentives\\RedencionesBundle\\Entity', 'IncentivesInventarioBundle' => 'Incentives\\InventarioBundle\\Entity', 'IncentivesServiciosBundle' => 'Incentives\\ServiciosBundle\\Entity', 'IncentivesGarantiasBundle' => 'Incentives\\GarantiasBundle\\Entity', 'IncentivesFacturacionBundle' => 'Incentives\\FacturacionBundle\\Entity', 'IncentivesOrdenesBundle' => 'Incentives\\OrdenesBundle\\Entity', 'IncentivesSolicitudesBundle' => 'Incentives\\SolicitudesBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9aa56ad399476728994948587cdfa33270368d5a3571948e0d710d1814bedfee');
    ...
    /**
     * Gets the 'incentives_catalogo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Incentives\CatalogoBundle\Model\catalogoFunciones A Incentives\CatalogoBundle\Model\catalogoFunciones instance
     */
    protected function getIncentivesCatalogoService()
    {
        return $this->services['incentives_catalogo'] = new \Incentives\CatalogoBundle\Model\catalogoFunciones($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'incentives_inventario' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Incentives\InventarioBundle\Model\inventarioFunciones A Incentives\InventarioBundle\Model\inventarioFunciones instance
     */
    protected function getIncentivesInventarioService()
    {
        return $this->services['incentives_inventario'] = new \Incentives\InventarioBundle\Model\inventarioFunciones($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'incentives_redenciones' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Incentives\RedencionesBundle\Model\redencionesFunciones A Incentives\RedencionesBundle\Model\redencionesFunciones instance
     */
    protected function getIncentivesRedencionesService()
    {
        return $this->services['incentives_redenciones'] = new \Incentives\RedencionesBundle\Model\redencionesFunciones($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'insert.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Incentives\BaseBundle\EventListener\LogRegister A Incentives\BaseBundle\EventListener\LogRegister instance
     */
    protected function getInsert_ListenerService()
    {
        return $this->services['insert.listener'] = new \Incentives\BaseBundle\EventListener\LogRegister($this);
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Symfony/Bundle/MonologBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Symfony/Bundle/AsseticBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer'), 'Incentives\\OperacionesBundle' => ($this->targetDirs[3].'/src/Incentives/OperacionesBundle/Resources/config/serializer'), 'Incentives\\BaseBundle' => ($this->targetDirs[3].'/src/Incentives/BaseBundle/Resources/config/serializer'), 'Incentives\\CatalogoBundle' => ($this->targetDirs[3].'/src/Incentives/CatalogoBundle/Resources/config/serializer'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/config/serializer'), 'Incentives\\RedencionesBundle' => ($this->targetDirs[3].'/src/Incentives/RedencionesBundle/Resources/config/serializer'), 'Incentives\\InventarioBundle' => ($this->targetDirs[3].'/src/Incentives/InventarioBundle/Resources/config/serializer'), 'Incentives\\ServiciosBundle' => ($this->targetDirs[3].'/src/Incentives/ServiciosBundle/Resources/config/serializer'), 'Incentives\\GarantiasBundle' => ($this->targetDirs[3].'/src/Incentives/GarantiasBundle/Resources/config/serializer'), 'Incentives\\FacturacionBundle' => ($this->targetDirs[3].'/src/Incentives/FacturacionBundle/Resources/config/serializer'), 'Incentives\\OrdenesBundle' => ($this->targetDirs[3].'/src/Incentives/OrdenesBundle/Resources/config/serializer'), 'BG\\BarcodeBundle' => ($this->targetDirs[3].'/vendor/bitgrave/barcode-bundle/Resources/config/serializer'), 'Incentives\\SolicitudesBundle' => ($this->targetDirs[3].'/src/Incentives/SolicitudesBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'SimpleThings\\EntityAudit' => ($this->targetDirs[3].'/vendor/simplethings/entity-audit-bundle/src/SimpleThings/EntityAudit/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer')));
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'KnpPaginatorBundle:Pagination:twitter_bootstrap_pagination.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 10));
    }
    ...
    /**
     * Gets the 'postpersist.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Incentives\BaseBundle\EventListener\LogRegister A Incentives\BaseBundle\EventListener\LogRegister instance
     */
    protected function getPostpersist_ListenerService()
    {
        return $this->services['postpersist.listener'] = new \Incentives\BaseBundle\EventListener\LogRegister($this);
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1)), 'Incentives\\BaseBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $h->setOptions(array('always_use_default_target_path' => true, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.user_db')), 'secured_area', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '579b9719272279.33806521', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getSimplethingsEntityaudit_ConfigService()
    {
        ...
        $instance->setAuditedEntityClasses(array(0 => 'Incentives\\OperacionesBundle\\Entity\\Aeconomica', 1 => 'Incentives\\OperacionesBundle\\Entity\\Archivos', 2 => 'Incentives\\FacturacionBundle\\Entity\\Areas', 3 => 'Incentives\\CatalogoBundle\\Entity\\Atributosproducto', 4 => 'Incentives\\CatalogoBundle\\Entity\\Atributostipo', 5 => 'Incentives\\OperacionesBundle\\Entity\\Catalogo', 6 => 'Incentives\\CatalogoBundle\\Entity\\CatalogoTipo', 7 => 'Incentives\\CatalogoBundle\\Entity\\Catalogos', 8 => 'Incentives\\OperacionesBundle\\Entity\\Categoria', 9 => 'Incentives\\InventarioBundle\\Entity\\CierreEstado', 10 => 'Incentives\\OperacionesBundle\\Entity\\Ciudad', 11 => 'Incentives\\CatalogoBundle\\Entity\\Cliente', 12 => 'Incentives\\OperacionesBundle\\Entity\\Contacto', 13 => 'Incentives\\OperacionesBundle\\Entity\\Convocatorias', 14 => 'Incentives\\OperacionesBundle\\Entity\\ConvocatoriasArchivos', 15 => 'Incentives\\OperacionesBundle\\Entity\\ConvocatoriasEstado', 16 => 'Incentives\\OperacionesBundle\\Entity\\ConvocatoriasHistorico', 17 => 'Incentives\\OperacionesBundle\\Entity\\ConvocatoriasProveedores', 18 => 'Incentives\\InventarioBundle\\Entity\\CostosLogistica', 19 => 'Incentives\\SolicitudesBundle\\Entity\\Cotizacion', 20 => 'Incentives\\SolicitudesBundle\\Entity\\CotizacionProducto', 21 => 'Incentives\\SolicitudesBundle\\Entity\\CotizacionesEstado', 22 => 'Incentives\\InventarioBundle\\Entity\\Courier', 23 => 'Incentives\\OperacionesBundle\\Entity\\Departamento', 24 => 'Incentives\\InventarioBundle\\Entity\\DespachoGuia', 25 => 'Incentives\\SolicitudesBundle\\Entity\\DespachoOrdenes', 26 => 'Incentives\\InventarioBundle\\Entity\\Despachos', 27 => 'Incentives\\CatalogoBundle\\Entity\\EstadoAprobacion', 28 => 'Incentives\\CatalogoBundle\\Entity\\EstadoCatalogo', 29 => 'Incentives\\CatalogoBundle\\Entity\\Estados', 30 => 'Incentives\\OperacionesBundle\\Entity\\Excel', 31 => 'Incentives\\CatalogoBundle\\Entity\\Excelmas', 32 => 'Incentives\\FacturacionBundle\\Entity\\Factura', 33 => 'Incentives\\FacturacionBundle\\Entity\\FacturaDetalle', 34 => 'Incentives\\FacturacionBundle\\Entity\\FacturaLogistica', 35 => 'Incentives\\FacturacionBundle\\Entity\\FacturaProductos', 36 => 'Incentives\\FacturacionBundle\\Entity\\Facturacostos', 37 => 'Incentives\\FacturacionBundle\\Entity\\Facturaestado', 38 => 'Incentives\\BaseBundle\\Entity\\Grupo', 39 => 'Incentives\\RedencionesBundle\\Entity\\GuiaEnvio', 40 => 'Incentives\\CatalogoBundle\\Entity\\Imagenproducto', 41 => 'Incentives\\CatalogoBundle\\Entity\\Intervalos', 42 => 'Incentives\\InventarioBundle\\Entity\\Inventario', 43 => 'Incentives\\InventarioBundle\\Entity\\InventarioGuia', 44 => 'Incentives\\InventarioBundle\\Entity\\InventarioHistorico', 45 => 'Incentives\\RedencionesBundle\\Entity\\Justificacion', 46 => 'Incentives\\BaseBundle\\Entity\\Menu', 47 => 'Incentives\\OrdenesBundle\\Entity\\MonedaTipo', 48 => 'Incentives\\GarantiasBundle\\Entity\\Novedades', 49 => 'Incentives\\GarantiasBundle\\Entity\\NovedadesDevolucionTipo', 50 => 'Incentives\\GarantiasBundle\\Entity\\Novedadesaccion', 51 => 'Incentives\\GarantiasBundle\\Entity\\Novedadesestado', 52 => 'Incentives\\GarantiasBundle\\Entity\\Novedadestipo', 53 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesCompra', 54 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesCompraHistorico', 55 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesEstado', 56 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesProducto', 57 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesProductoHistorico', 58 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesTipo', 59 => 'Incentives\\OperacionesBundle\\Entity\\Pais', 60 => 'Incentives\\RedencionesBundle\\Entity\\Participantes', 61 => 'Incentives\\RedencionesBundle\\Entity\\Participantesestado', 62 => 'Incentives\\FacturacionBundle\\Entity\\Periodos', 63 => 'Incentives\\InventarioBundle\\Entity\\Planilla', 64 => 'Incentives\\InventarioBundle\\Entity\\PlanillaEstado', 65 => 'Incentives\\InventarioBundle\\Entity\\PlanillaTipo', 66 => 'Incentives\\CatalogoBundle\\Entity\\Preciohistorico', 67 => 'Incentives\\FacturacionBundle\\Entity\\Presupuestos', 68 => 'Incentives\\FacturacionBundle\\Entity\\Presupuestoshistorico', 69 => 'Incentives\\SolicitudesBundle\\Entity\\Prioridad', 70 => 'Incentives\\CatalogoBundle\\Entity\\Producto', 71 => 'Incentives\\CatalogoBundle\\Entity\\ProductoCalificacion', 72 => 'Incentives\\CatalogoBundle\\Entity\\ProductoIdiomas', 73 => 'Incentives\\CatalogoBundle\\Entity\\ProductoTipo', 74 => 'Incentives\\CatalogoBundle\\Entity\\Productocatalogo', 75 => 'Incentives\\CatalogoBundle\\Entity\\ProductocatalogoHistorico', 76 => 'Incentives\\CatalogoBundle\\Entity\\Productoclasificacion', 77 => 'Incentives\\CatalogoBundle\\Entity\\Productoprecio', 78 => 'Incentives\\CatalogoBundle\\Entity\\Programa', 79 => 'Incentives\\OperacionesBundle\\Entity\\Proveedores', 80 => 'Incentives\\OperacionesBundle\\Entity\\ProveedoresArea', 81 => 'Incentives\\OperacionesBundle\\Entity\\ProveedoresCalificacion', 82 => 'Incentives\\OperacionesBundle\\Entity\\ProveedoresClasificacion', 83 => 'Incentives\\OperacionesBundle\\Entity\\ProveedoresHistorico', 84 => 'Incentives\\OperacionesBundle\\Entity\\ProveedoresTipo', 85 => 'Incentives\\RedencionesBundle\\Entity\\Redenciones', 86 => 'Incentives\\RedencionesBundle\\Entity\\RedencionesHistorico', 87 => 'Incentives\\RedencionesBundle\\Entity\\Redencionesatributos', 88 => 'Incentives\\RedencionesBundle\\Entity\\Redencionesenvios', 89 => 'Incentives\\RedencionesBundle\\Entity\\Redencionesestado', 90 => 'Incentives\\OperacionesBundle\\Entity\\Regimen', 91 => 'Incentives\\SolicitudesBundle\\Entity\\Requisicion', 92 => 'Incentives\\SolicitudesBundle\\Entity\\RequisicionProducto', 93 => 'Incentives\\InventarioBundle\\Entity\\Requisicionesenvios', 94 => 'Incentives\\ServiciosBundle\\Entity\\Servicios', 95 => 'Incentives\\ServiciosBundle\\Entity\\ServiciosLog', 96 => 'Incentives\\SolicitudesBundle\\Entity\\Solicitud', 97 => 'Incentives\\SolicitudesBundle\\Entity\\SolicitudTipo', 98 => 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesArchivos', 99 => 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesAsignar', 100 => 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesEstado', 101 => 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesObservaciones', 102 => 'Incentives\\OperacionesBundle\\Entity\\Tipoarchivo', 103 => 'Incentives\\FacturacionBundle\\Entity\\Tipocostos', 104 => 'Incentives\\OperacionesBundle\\Entity\\Tipodocumento', 105 => 'Incentives\\OrdenesBundle\\Entity\\Tracking', 106 => 'Incentives\\BaseBundle\\Entity\\Usuario', 107 => 'Incentives\\BaseBundle\\Entity\\Menu', 108 => 'Incentives\\BaseBundle\\Entity\\Grupo'));
    ...
    {
        return $this->services['simplethings_entityaudit.request.current_user_listener'] = new \SimpleThings\EntityAudit\Request\CurrentUserListener($this->get('simplethings_entityaudit.config'), $this->get('security.token_storage'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('gahl98');
        $a->setPassword('Prueba2012');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Incentives/OperacionesBundle/Resources/views'), 'IncentivesOperaciones');
        $instance->addPath(($this->targetDirs[3].'/src/Incentives/BaseBundle/Resources/views'), 'IncentivesBase');
        $instance->addPath(($this->targetDirs[3].'/src/Incentives/CatalogoBundle/Resources/views'), 'IncentivesCatalogo');
        $instance->addPath(($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/views'), 'KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'/src/Incentives/RedencionesBundle/Resources/views'), 'IncentivesRedenciones');
        $instance->addPath(($this->targetDirs[3].'/src/Incentives/InventarioBundle/Resources/views'), 'IncentivesInventario');
        $instance->addPath(($this->targetDirs[3].'/src/Incentives/ServiciosBundle/Resources/views'), 'IncentivesServicios');
        $instance->addPath(($this->targetDirs[3].'/src/Incentives/GarantiasBundle/Resources/views'), 'IncentivesGarantias');
        $instance->addPath(($this->targetDirs[3].'/src/Incentives/FacturacionBundle/Resources/views'), 'IncentivesFacturacion');
        $instance->addPath(($this->targetDirs[3].'/src/Incentives/OrdenesBundle/Resources/views'), 'IncentivesOrdenes');
        $instance->addPath(($this->targetDirs[3].'/src/Incentives/SolicitudesBundle/Resources/views'), 'IncentivesSolicitudes');
    ...
    /**
     * Gets the 'update.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Incentives\BaseBundle\EventListener\LogRegister A Incentives\BaseBundle\EventListener\LogRegister instance
     */
    protected function getUpdate_ListenerService()
    {
        return $this->services['update.listener'] = new \Incentives\BaseBundle\EventListener\LogRegister($this);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b890138ca01ea744ecc14707265f5ff93137043d');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/Incentives/OperacionesBundle/Resources/config/validation.yml'), 1 => ($this->targetDirs[3].'/src/Incentives/OrdenesBundle/Resources/config/validation.yml')));
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/recordar'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/proveedores/pass'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/_wdt'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/servicios'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/.*'), array(0 => 'ROLE_DIR', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ASIS', 3 => 'ROLE_ASISCOMP', 4 => 'ROLE_EJEC', 5 => 'ROLE_CALL', 6 => 'ROLE_SERV', 7 => 'ROLE_CALD', 8 => 'ROLE_LOGIS', 9 => 'ROLE_CAT', 10 => 'ROLE_PROV', 11 => 'ROLE_COM', 12 => 'ROLE_CLI', 13 => 'ROLE_BOD'), NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CAT' => array(0 => 'ROLE_USER0'), 'ROLE_LOGIS' => array(0 => 'ROLE_USER0'), 'ROLE_CALD' => array(0 => 'ROLE_USER0'), 'ROLE_SERV' => array(0 => 'ROLE_USER0'), 'ROLE_CALL' => array(0 => 'ROLE_USER0'), 'ROLE_EJEC' => array(0 => 'ROLE_USER0'), 'ROLE_ASISCOMP' => array(0 => 'ROLE_USER0'), 'ROLE_ASIS' => array(0 => 'ROLE_USER0'), 'ROLE_PROV' => array(0 => 'ROLE_USER0'), 'ROLE_DIR' => array(0 => 'ROLE_USER0'), 'ROLE_USER' => array(0 => 'ROLE_USER0'), 'ROLE_COM' => array(0 => 'ROLE_USER0'), 'ROLE_CLI' => array(0 => 'ROLE_USER0'), 'ROLE_BOD' => array(0 => 'ROLE_USER0'), 'ROLE_ADMIN' => array(0 => 'ROLE_DIR'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('ryan', 'bb87a29949f3a1ee0559f8a57357487151281386', array(0 => 'ROLE_USER')));
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Incentives\\BaseBundle\\Entity\\Usuario', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IncentivesOperacionesBundle' => 'Incentives\\OperacionesBundle\\IncentivesOperacionesBundle',
                'IncentivesBaseBundle' => 'Incentives\\BaseBundle\\IncentivesBaseBundle',
                'IncentivesCatalogoBundle' => 'Incentives\\CatalogoBundle\\IncentivesCatalogoBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'IncentivesRedencionesBundle' => 'Incentives\\RedencionesBundle\\IncentivesRedencionesBundle',
                'IncentivesInventarioBundle' => 'Incentives\\InventarioBundle\\IncentivesInventarioBundle',
                'IncentivesServiciosBundle' => 'Incentives\\ServiciosBundle\\IncentivesServiciosBundle',
                'IncentivesGarantiasBundle' => 'Incentives\\GarantiasBundle\\IncentivesGarantiasBundle',
                'IncentivesFacturacionBundle' => 'Incentives\\FacturacionBundle\\IncentivesFacturacionBundle',
                'IncentivesOrdenesBundle' => 'Incentives\\OrdenesBundle\\IncentivesOrdenesBundle',
                'BarcodeBundle' => 'BG\\BarcodeBundle\\BarcodeBundle',
                'IncentivesSolicitudesBundle' => 'Incentives\\SolicitudesBundle\\IncentivesSolicitudesBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'incoperaciones_prod',
            'database_user' => 'root',
            'database_password' => 'orwell',
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => 'gahl98',
            'mailer_password' => 'Prueba2012',
            'locale' => 'es',
            'secret' => 'b890138ca01ea744ecc14707265f5ff93137043d',
            ...
            'kernel.secret' => 'b890138ca01ea744ecc14707265f5ff93137043d',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'gahl98',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Prueba2012',
            ...
            'assetic.node.bin' => ($this->targetDirs[5].'/.nvm/v0.10.35/bin/node'),
            'assetic.ruby.bin' => '/usr/local/rvm/rubies/ruby-2.1.5/bin/ruby',
            'assetic.sass.bin' => '/usr/local/rvm/gems/ruby-2.1.5@rails4/bin/sass',
            ...
            'simplethings.entityaudit.audited_entities' => array(
                0 => 'Incentives\\OperacionesBundle\\Entity\\Aeconomica',
                1 => 'Incentives\\OperacionesBundle\\Entity\\Archivos',
                2 => 'Incentives\\FacturacionBundle\\Entity\\Areas',
                3 => 'Incentives\\CatalogoBundle\\Entity\\Atributosproducto',
                4 => 'Incentives\\CatalogoBundle\\Entity\\Atributostipo',
                5 => 'Incentives\\OperacionesBundle\\Entity\\Catalogo',
                6 => 'Incentives\\CatalogoBundle\\Entity\\CatalogoTipo',
                7 => 'Incentives\\CatalogoBundle\\Entity\\Catalogos',
                8 => 'Incentives\\OperacionesBundle\\Entity\\Categoria',
                9 => 'Incentives\\InventarioBundle\\Entity\\CierreEstado',
                10 => 'Incentives\\OperacionesBundle\\Entity\\Ciudad',
                11 => 'Incentives\\CatalogoBundle\\Entity\\Cliente',
                12 => 'Incentives\\OperacionesBundle\\Entity\\Contacto',
                13 => 'Incentives\\OperacionesBundle\\Entity\\Convocatorias',
                14 => 'Incentives\\OperacionesBundle\\Entity\\ConvocatoriasArchivos',
                15 => 'Incentives\\OperacionesBundle\\Entity\\ConvocatoriasEstado',
                16 => 'Incentives\\OperacionesBundle\\Entity\\ConvocatoriasHistorico',
                17 => 'Incentives\\OperacionesBundle\\Entity\\ConvocatoriasProveedores',
                18 => 'Incentives\\InventarioBundle\\Entity\\CostosLogistica',
                19 => 'Incentives\\SolicitudesBundle\\Entity\\Cotizacion',
                20 => 'Incentives\\SolicitudesBundle\\Entity\\CotizacionProducto',
                21 => 'Incentives\\SolicitudesBundle\\Entity\\CotizacionesEstado',
                22 => 'Incentives\\InventarioBundle\\Entity\\Courier',
                23 => 'Incentives\\OperacionesBundle\\Entity\\Departamento',
                24 => 'Incentives\\InventarioBundle\\Entity\\DespachoGuia',
                25 => 'Incentives\\SolicitudesBundle\\Entity\\DespachoOrdenes',
                26 => 'Incentives\\InventarioBundle\\Entity\\Despachos',
                27 => 'Incentives\\CatalogoBundle\\Entity\\EstadoAprobacion',
                28 => 'Incentives\\CatalogoBundle\\Entity\\EstadoCatalogo',
                29 => 'Incentives\\CatalogoBundle\\Entity\\Estados',
                30 => 'Incentives\\OperacionesBundle\\Entity\\Excel',
                31 => 'Incentives\\CatalogoBundle\\Entity\\Excelmas',
                32 => 'Incentives\\FacturacionBundle\\Entity\\Factura',
                33 => 'Incentives\\FacturacionBundle\\Entity\\FacturaDetalle',
                34 => 'Incentives\\FacturacionBundle\\Entity\\FacturaLogistica',
                35 => 'Incentives\\FacturacionBundle\\Entity\\FacturaProductos',
                36 => 'Incentives\\FacturacionBundle\\Entity\\Facturacostos',
                37 => 'Incentives\\FacturacionBundle\\Entity\\Facturaestado',
                38 => 'Incentives\\BaseBundle\\Entity\\Grupo',
                39 => 'Incentives\\RedencionesBundle\\Entity\\GuiaEnvio',
                40 => 'Incentives\\CatalogoBundle\\Entity\\Imagenproducto',
                41 => 'Incentives\\CatalogoBundle\\Entity\\Intervalos',
                42 => 'Incentives\\InventarioBundle\\Entity\\Inventario',
                43 => 'Incentives\\InventarioBundle\\Entity\\InventarioGuia',
                44 => 'Incentives\\InventarioBundle\\Entity\\InventarioHistorico',
                45 => 'Incentives\\RedencionesBundle\\Entity\\Justificacion',
                46 => 'Incentives\\BaseBundle\\Entity\\Menu',
                47 => 'Incentives\\OrdenesBundle\\Entity\\MonedaTipo',
                48 => 'Incentives\\GarantiasBundle\\Entity\\Novedades',
                49 => 'Incentives\\GarantiasBundle\\Entity\\NovedadesDevolucionTipo',
                50 => 'Incentives\\GarantiasBundle\\Entity\\Novedadesaccion',
                51 => 'Incentives\\GarantiasBundle\\Entity\\Novedadesestado',
                52 => 'Incentives\\GarantiasBundle\\Entity\\Novedadestipo',
                53 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesCompra',
                54 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesCompraHistorico',
                55 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesEstado',
                56 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesProducto',
                57 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesProductoHistorico',
                58 => 'Incentives\\OrdenesBundle\\Entity\\OrdenesTipo',
                59 => 'Incentives\\OperacionesBundle\\Entity\\Pais',
                60 => 'Incentives\\RedencionesBundle\\Entity\\Participantes',
                61 => 'Incentives\\RedencionesBundle\\Entity\\Participantesestado',
                62 => 'Incentives\\FacturacionBundle\\Entity\\Periodos',
                63 => 'Incentives\\InventarioBundle\\Entity\\Planilla',
                64 => 'Incentives\\InventarioBundle\\Entity\\PlanillaEstado',
                65 => 'Incentives\\InventarioBundle\\Entity\\PlanillaTipo',
                66 => 'Incentives\\CatalogoBundle\\Entity\\Preciohistorico',
                67 => 'Incentives\\FacturacionBundle\\Entity\\Presupuestos',
                68 => 'Incentives\\FacturacionBundle\\Entity\\Presupuestoshistorico',
                69 => 'Incentives\\SolicitudesBundle\\Entity\\Prioridad',
                70 => 'Incentives\\CatalogoBundle\\Entity\\Producto',
                71 => 'Incentives\\CatalogoBundle\\Entity\\ProductoCalificacion',
                72 => 'Incentives\\CatalogoBundle\\Entity\\ProductoIdiomas',
                73 => 'Incentives\\CatalogoBundle\\Entity\\ProductoTipo',
                74 => 'Incentives\\CatalogoBundle\\Entity\\Productocatalogo',
                75 => 'Incentives\\CatalogoBundle\\Entity\\ProductocatalogoHistorico',
                76 => 'Incentives\\CatalogoBundle\\Entity\\Productoclasificacion',
                77 => 'Incentives\\CatalogoBundle\\Entity\\Productoprecio',
                78 => 'Incentives\\CatalogoBundle\\Entity\\Programa',
                79 => 'Incentives\\OperacionesBundle\\Entity\\Proveedores',
                80 => 'Incentives\\OperacionesBundle\\Entity\\ProveedoresArea',
                81 => 'Incentives\\OperacionesBundle\\Entity\\ProveedoresCalificacion',
                82 => 'Incentives\\OperacionesBundle\\Entity\\ProveedoresClasificacion',
                83 => 'Incentives\\OperacionesBundle\\Entity\\ProveedoresHistorico',
                84 => 'Incentives\\OperacionesBundle\\Entity\\ProveedoresTipo',
                85 => 'Incentives\\RedencionesBundle\\Entity\\Redenciones',
                86 => 'Incentives\\RedencionesBundle\\Entity\\RedencionesHistorico',
                87 => 'Incentives\\RedencionesBundle\\Entity\\Redencionesatributos',
                88 => 'Incentives\\RedencionesBundle\\Entity\\Redencionesenvios',
                89 => 'Incentives\\RedencionesBundle\\Entity\\Redencionesestado',
                90 => 'Incentives\\OperacionesBundle\\Entity\\Regimen',
                91 => 'Incentives\\SolicitudesBundle\\Entity\\Requisicion',
                92 => 'Incentives\\SolicitudesBundle\\Entity\\RequisicionProducto',
                93 => 'Incentives\\InventarioBundle\\Entity\\Requisicionesenvios',
                94 => 'Incentives\\ServiciosBundle\\Entity\\Servicios',
                95 => 'Incentives\\ServiciosBundle\\Entity\\ServiciosLog',
                96 => 'Incentives\\SolicitudesBundle\\Entity\\Solicitud',
                97 => 'Incentives\\SolicitudesBundle\\Entity\\SolicitudTipo',
                98 => 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesArchivos',
                99 => 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesAsignar',
                100 => 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesEstado',
                101 => 'Incentives\\SolicitudesBundle\\Entity\\SolicitudesObservaciones',
                102 => 'Incentives\\OperacionesBundle\\Entity\\Tipoarchivo',
                103 => 'Incentives\\FacturacionBundle\\Entity\\Tipocostos',
                104 => 'Incentives\\OperacionesBundle\\Entity\\Tipodocumento',
                105 => 'Incentives\\OrdenesBundle\\Entity\\Tracking',
                106 => 'Incentives\\BaseBundle\\Entity\\Usuario',
                107 => 'Incentives\\BaseBundle\\Entity\\Menu',
                108 => 'Incentives\\BaseBundle\\Entity\\Grupo',
            ),
